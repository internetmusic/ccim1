...
public class UserBase {
	...
	private List<CCIM1> wallet_CCIM1 = new ArrayList<>();
	...
	public List<CCIM1> getCCIM1() {
		return this.wallet_CCIM1;
	}

	public void addCCIM1(CCIM1 CCIM1) {
		this.wallet_CCIM1.add(CCIM1);
	}

	public void removeCCIM1(CCIM1 CCIM1) {
		this.wallet_CCIM1.remove(CCIM1);
	}
