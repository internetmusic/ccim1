...
import com.ccim.db.ccim_db.dtos.UserDto;
import com.ccim.db.ccim_db.entity.Roles;

//IMPORT RELATIONS

import com.ccim.db.ccim_db.service.CCIM1Service;

import com.ccim.db.ccim_db.service.RolesService;
...
//CRUD METHODS
	...
	public ResponseEntity<UserDto> insert(@RequestBody User obj) {
		...
		//external relation CCIM1
		if (obj.getCCIM1() != null && !obj.getCCIM1().isEmpty())
			obj.getCCIM1().forEach(ccim1 -> ccim1Service.insert(ccim1));
	...
	public ResponseEntity<Void> delete(@PathVariable("id") Long id) {
		...
		//external relation CCIM1
		if (userSelected.getCCIM1() != null && !userSelected.getCCIM1().isEmpty()) {
			userSelected.getCCIM1().forEach(ccim1 -> ccim1Service.delete(ccim1.get_id()));
		}
